...
public class ButteurBDL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butteur_bdl);
    ...
    public void getData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ConfigB.URLBDL, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ButteurBDL.this,"Check your network connexion",Toast.LENGTH_LONG).show();
                loading.dismiss();
