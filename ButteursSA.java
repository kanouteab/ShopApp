...
public class ButteursSA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butteurs_s);
    ...
    public void getData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ConfigB.URLSA, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ButteursSA.this,"Check your network connexion",Toast.LENGTH_LONG).show();
                loading.dismiss();
