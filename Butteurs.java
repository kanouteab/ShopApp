...
public class Butteurs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butteurs);
    ...
    JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ConfigB.urlAddress, new Response.Listener<JSONArray>() {
        @Override
        ...
        public void onErrorResponse(VolleyError error) {
            Toast.makeText(Butteurs.this,"Check your network connexion please",Toast.LENGTH_LONG).show();
            loading.dismiss();
